...
export const TARGET_GROUPS = [
    { id: -1003681496844, name: "SMM LID Центральный офис", limit: 70 },
    { id: -1003411289776, name: "SMM LID Parkent", limit: 60 },
    { id: -1003573376730, name: "SMM LID Yangi bozor", limit: 15 },
    { id: -1003512729243, name: "SMM LID Юнусабад", limit: 30 },
